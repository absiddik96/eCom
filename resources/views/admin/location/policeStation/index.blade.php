    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Upazila / Police Station</h3>
                        ...
                        @if (count($policeStations))
                            @foreach ($policeStations as $policeStation)
                                <tr>
                                    ...
                                    <td>
                                        <a style="margin-right:5px" href="{{route('sys-police-station.edit',$policeStation->id)}}" class="btn btn-xs btn-primary pull-left">Edit</a>

                                        {{Form::open(['route'=>['sys-police-station.destroy',$policeStation->id],'method'=>'DELETE'])}}
